...
public class Teste {
	...
	public static void main(String[] args) {
		...
		Pedido ped = new Pedido(27, "27/05/2018", "Débito", 755.1, "Pago");

		ped.mostrar();

		Notebook note = new Notebook(50, "Dell Core i7", "Notebook Dell", 30, 1230.50, "img\\ddr22br.jpg",
				"20/07/2011");

		note.mostrar();

		ItemDePedido IDP = new ItemDePedido(45, 236.65);

		IDP.mostrar();

		Endereco end = new Endereco("Rua", "09", "Nenhum", "Irajá", "Rio de Janeiro", "Rio de Janeiro", "20975-423");
		end.mostrar();
	}
}